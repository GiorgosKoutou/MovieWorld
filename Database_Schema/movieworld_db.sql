...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Aug 04, 2025 at 07:35 AM
...
--
CREATE DATABASE IF NOT EXISTS `movieworld_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `movieworld_db`;
...
CREATE TABLE `votings` (
  ...
  `is_hate` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
